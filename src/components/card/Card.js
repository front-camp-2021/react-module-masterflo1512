    ...
    return (
        <section className="card-container">
            <div className="content">
                <div className="image">
                    <img src="apple-watch.jpg" alt="Apple Watch Series 4 GPS" />
                </div>
                ...
                <div className="name-description-container">
                    ...
                    <p className="product-description" title="Redesigned from scratch and completely revised">Redesigned from scratch and completely revised.</p>
                </div>
            </div>
