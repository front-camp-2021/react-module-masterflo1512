        ...
        <div className="product-list row">
            <div className="col-lg-4 col-md-6">
                <section className="card-container">
                    ...
                    <div className="content">
                        <div className="image">
                            <img src="../images/apple-watch.jpg" alt="Apple Watch Series 4 GPS" />
                        </div>
            ...
            <div className="col-lg-4 col-md-6">
                <section className="card-container">
                    <div className="content">
                        <div className="image">
                            <img src="../images/jbl-speaker.jpg" alt="JBL Speaker" />
                        </div>
                        <div className="container-rating-price">
            ...
            <div className="col-lg-4 col-md-6">
                <section className="card-container">
                    <div className="content">
                        <div className="image">
                            <img src="../images/iphone-x.jpg" alt="Apple iPhone X 128GB" />
                        </div>
                        <div className="container-rating-price">
                            <div className="rating">
                                <span className="rating-value">3.4</span>
            ...
            <div className="col-lg-4 col-md-6">
                <section className="card-container">
                    <div className="content">
                        <div className="image">
                            <img src="../images/beats-headphones.jpg" alt="Beats Headphones" />
                        </div>
                        <div className="container-rating-price">
                            <div className="rating">
                                <span className="rating-value">3.4</span>
