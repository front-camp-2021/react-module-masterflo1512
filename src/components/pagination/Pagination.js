...
export function Pagination(props) {
    ...
    return (
        <div className="pagination-container">
            <button className="btn-pagination" onClick={() => setCurrentPage((prev) => prev - 1)} disabled={`${currentPage === 1 ? 'disabled' : ''}`}>
            ...
            <button className="btn-pagination" disabled={currentPage === numberOfPages.length} onClick={() => setCurrentPage((prev) => prev + 1)}>
